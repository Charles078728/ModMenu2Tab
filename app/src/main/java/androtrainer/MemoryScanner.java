...
public class MemoryScanner
{
	...
	protected native void search(long c_instance, String value, int TYPE);
	protected native void refine(long c_instance, String value, int TYPE, long offset);
	protected native void editAll(long c_instance, String value, int TYPE, long offset);
	...
	protected native ScannerAddress[] getResults(long c_instance,int TYPE);
	...
	{
		if (flag < TYPE.DOUBLE || flag > TYPE.BYTE)
		{
